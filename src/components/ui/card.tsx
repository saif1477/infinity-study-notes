...
function Card({ className, ...props }: React.ComponentProps<"div"> & { variant?: "default" | "glass" | "gradient" }) {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "gradient" && "bg-gradient-to-br from-card to-card/40 border-primary/20",
        className
      )}
      {...rest}
    />
